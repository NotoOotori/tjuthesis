...
% 但不可以同时使用
\usepackage[amsmath,thmmarks,hyperref,thref]{ntheorem}
% change counter, including the macro counterwithin and counterwithout 
\usepackage{chngcntr}
...
\newcommand{\LstlistingLabel}[1]{\LstlistingLang#1}
\labelformat{lstlisting}{\LstlistingLabel{#1}}
\renewcommand\lstlistingname{\LstlistingLang}

\RequirePackage[numbered,framed]{matlab-prettifier} % for matlab code 
...
\newcommand{\minputlisting}[2][]{ % #1: caption or label
    \lstinputlisting[
        style=MATLAB-editor,
...
\newcommand{\matlabinputlisting}[2][]{
...
\newenvironment{longcode}{\captionsetup{type=listing,name={代码}}}{}
\RequirePackage{xcolor} % the above four options and packages are used for code highlighted, together with caption positioned on top.

\RequirePackage{diagbox} % draw diagonal line in a cell of tabular

\RequirePackage{algorithm}
\RequirePackage{algorithmicx}
\RequirePackage{algpseudocode} % algorithm and pseudocode package
